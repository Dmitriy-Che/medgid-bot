...
async def handle_channel_link(message: types.Message):
    ...
    await message.answer(
        ...
        "✅ Обзоры медицинских услуг в Подмосковье",
        parse_mode="HTML",
...
async def handle_share_bot(message: types.Message):
    ...
    share_text = (
        "🤖 Нашел полезного бота для поиска врачей!\n\n"
    ...
    await message.answer(
        ...
        "Помогите им найти хороших врачей в вашем городе. "
    ...
    for user in users:
        try:
            ...
            await bot.send_message(
                ...
                "• 📢 Перейти в наш канал\n"
                "• 📤 Поделиться ботом\n\n"
                "Подписывайтесь на канал МедГид МО - новости медицины Подмосковья!",
                parse_mode="HTML",
...
async def cmd_start(message: types.Message, state: FSMContext):
    ...
    caption = (
        "👋 Добро пожаловать в <b>МедГид – Подмосковье!</b> 🩺\n\n"
        "Что я умею:\n"
